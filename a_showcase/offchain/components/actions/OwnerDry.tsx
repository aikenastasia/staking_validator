...
export default function OwnerDry(props: { onLock: Action; onUnlock: Action; onDelegateStake: Action; onWithdrawStake: Action; onUnregisterStake: Action }) {
  const { onLock, onUnlock, onDelegateStake, onWithdrawStake, onUnregisterStake } = props;
  ...
  return (
    <div className="flex flex-wrap gap-2 mb-2">
      ...
      <LockButton />
      <Button className="bg-gradient-to-tr from-primary-500 to-teal-500 text-white shadow-lg" radius="full" onPress={onUnlock}>
        Unlock
      </Button>
