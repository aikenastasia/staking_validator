    ...
    DRY: {
      mint: async (tokenName: string) => {
        try {
          ...
          submitTx(tx)
            .then((result) => {
              localStorage.setItem("stake_answer.dry_policyid", policyID);
              localStorage.setItem("stake_answer.dry_assetname", assetName);
      ...
      lock: async (lovelace: Lovelace) => {
        try {
          ...
          const policyID = localStorage.getItem("stake_answer.dry_policyid");
      ...
      unlock: async () => {
        try {
          ...
          const policyID = localStorage.getItem("stake_answer.dry_policyid");
          const assetName = localStorage.getItem("stake_answer.dry_assetname");
